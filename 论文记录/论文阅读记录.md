...
* 新学到的两个概念
    ...
    * Zero-shot learning 指的是我们之前没有这个类别的训练样本。但是可以学习到一个映射X-Y
...
* Task：
    ...
    * 举例：虽然没有okapi的图片，但根据okapi与zebra的关系，基于ebra的向量学习出okapi的向量，再把这个向量map到okapi的类别名上

* 疑问：将okapi类别的词向量转化为category后，怎么和图片建立关系？ 
